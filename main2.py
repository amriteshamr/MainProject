...
from Face_Rec2 import FaceRecog
import pickle
...
test = ['Test_images/test_image5.jpg', 'Test_images/test_image9.jpg', 'Test_images/test_image7.jpg' ]
#test = fr.capture()
...
for i in range(3):
    ...
    test_locations, test_encodings = fr.identify(test[i])
    img = face_recognition.load_image_file(test[i])
    ...
    pil_image.show()
    pil_image.save('Final/image_{}.jpg'.format(i))
