#This file identify faces from training images and encodes them, and then stores the encodings and respective names to 2 .dat files
#This code is run once at the beginning
#if new faces are to be added, their image should be added to the training images folder and this program should be run again
